...
################################# Ensemble
ensemble_model = ensemble.Ensemble(EnsModel, 32, load_path="trained_models/ens_emnist")
...
ccat.ccat_model.load_state_dict(torch.load("trained_models/ccat_emnist.pth.tar"))
